    ...
    return (
      <div style={{ display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', height:'100vh', textAlign:'center', padding:32, gap:16 }}>
        ...
        <p style={{ fontSize:14, color:'#888', margin:0, lineHeight:1.5 }}>
          {isNotLinked ? "@Zoya_app_bot ga o'ting va /start bosib, telefon raqamingizni yuboring" : error}
        </p>
        {isNotLinked && (
          <a href="https://t.me/Zoya_app_bot" style={{ marginTop:8, padding:'12px 28px', background:'#007A6B', color:'white', borderRadius:12, textDecoration:'none', fontSize:15, fontWeight:500 }}>
            Botni ochish
          </a>
        )}
      </div>
